...
function CheckBatteryHealth
{
	...
	# SMTP Server Name
	$SMTPServer = "smtp.xcentral.com.au"

	# Email Server Variables
	$Recipient = "IT Helpdesk chris.jones@xcentral.com.au"
	$Sender = "Battery Health Check support@xcentral.com.au"
