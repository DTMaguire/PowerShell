...
$UserList = (Get-ADUser -Filter 'Enabled -eq $True' | Select-Object -ExpandProperty SamAccountName | Get-RemoteMailbox -Erroraction 'SilentlyContinue' | Select-Object Name,SamAccountName,Alias,UserPrincipalName,PrimarySMTPAddress)
$MismatchedUsers = @()
